...
/* ------------------- data ------------------- */
const SERVICE_CATEGORIES = ["All", "Web", "Software", "Apps", "Games", "Design"];
...
const SERVICES = [
  {
    ...
    category: "Web",
    tag: "Sites • Portals",
    desc: "High-performance websites, landing systems, dashboards, and marketing experiences with sharp UI and clean delivery.",
    metricA: "Speed",
    metricB: "SEO",
    accent: "grid",
  },
  {
    ...
    category: "Software",
    tag: "SaaS • ERP",
    desc: "Production-grade software systems: admin panels, workflows, analytics, integrations, and scalable backends.",
    metricA: "Scale",
    metricB: "Security",
    accent: "mono",
  },
  {
    ...
    category: "Apps",
    tag: "iOS • Android",
    desc: "Mobile-first applications with solid architecture, sharp UX, and reliable performance across devices.",
    metricA: "UX",
    metricB: "Stability",
    accent: "orange",
  },
  {
    ...
    category: "Games",
    tag: "WebGL • 2D",
    desc: "Lightweight games, interactive demos, and real-time experiences designed for engagement and fast load times.",
    metricA: "Fun",
    metricB: "Fast",
    accent: "mono",
  },
  {
    ...
    category: "Design",
    tag: "UI • Brand",
    desc: "Design systems, product UI, brand identity, and prototypes that are clean, structured, and dev-ready.",
    metricA: "Clarity",
    metricB: "Consistency",
    accent: "orange",
  },
        ...
        <div className="grid grid-cols-12 gap-0 border border-black/25 bg-[#d9d9d9]">
          ...
          <Tile className="col-span-12 md:col-span-4 min-h-[260px] md:min-h-[320px]">
            <div className="h-full p-5 sm:p-6">
              ...
              >
                We build products and deliver services with the same discipline: sharp design,
                clean architecture, fast iteration, and production-ready output — from web to apps,
                software systems, games, and a full design studio.
              </p>
                    ...
                    return (
                      <button
                        ...
                        className={[
                          ...
                          active
                            ? "bg-[#ff5a12] text-white hover:bg-[#ff5a12]"
                            : "",
                        ].join(" ")}
                        type="button"
                      >
              ...
              <div className="relative">
                <div className="flex items-start justify-between gap-4">
                  <div>
                    ...
                    >
                      Define → Design → Build → Launch → Optimize. We deliver with sharp borders,
                      clean visuals, and performance-first engineering.
                    </p>
                  </div>
                ...
                <div className="mt-6 grid grid-cols-2 sm:grid-cols-4 gap-2">
                  <MiniStat label="Discovery" value="Clear" />
                  <MiniStat label="Design" value="Sharp" />
                  <MiniStat label="Build" value="Fast" />
                  <MiniStat label="Scale" value="Ready" />
                </div>

                {/* Unique: pipeline strip */}
                <div className="mt-6 border border-black/20 bg-white/35 p-4">
                  ...
                  <div className="mt-4 grid grid-cols-2 sm:grid-cols-4 gap-2">
                    <MiniStat label="Web" value="Systems" />
                    <MiniStat label="Apps" value="Mobile" />
                    <MiniStat label="Games" value="Interactive" />
                    <MiniStat label="Design" value="Studio" />
                  </div>
                </div>
              </div>
            </div>
  ...
  return (
    <div data-card className="relative h-full p-5 sm:p-6">
      ...
      <div className="mt-5 grid grid-cols-2 gap-2">
        <MiniStat label="Focus" value={service.metricA} />
        <MiniStat label="Value" value={service.metricB} />
      </div>
      ...
      <div className="mt-5 border-t border-black/15 pt-4 flex items-center justify-between">
        ...
        <CornerButton className="px-4 py-2 text-[11px]">EXPLORE ↗</CornerButton>
      </div>
    </div>
  );
}
