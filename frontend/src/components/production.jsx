...
//     // keeps 4 items in rotation (works even if products < 4)
...
//               <h2 className="prod-glitch text-[40px] font-black tracking-[0.14em] text-black md:text-[70px]">
//                 OUR PRODUCTS
//               </h2>
//             </div>
//           </Tile>
...
//               <p className="max-w-[320px] font-mono text-[15px] leading-relaxed text-black/80">
//                 • Built for teams
//                 <br />
...
//         <div className="prod-glitch-sm text-[16px] font-semibold tracking-wide text-black">
//           {product.name}
//         </div>
//         <div className="mt-1 text-[12px] font-black tracking-[0.2em] text-black/60">
//           {product.role}
//         </div>
//       </div>

//       {/* Image area with distortion */}
...
//       {/* Bottom CTA */}
//       <button className="group border-t border-black/20 bg-white/18 px-5 py-4 text-center font-mono text-[13px] tracking-widest text-black/80 hover:bg-white/45">
...
export default function ProductsSection({ products = demoProducts }) {
  ...
  // ✅ Animate word-by-word when in viewport
  useEffect(() => {
    ...
    return () => ctx.revert();
  }, [visible]); // re-split/animate for new visible cards when you click next/prev
