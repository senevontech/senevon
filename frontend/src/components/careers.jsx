...
//                         "shrink-0 rounded-full border px-4 py-2 text-[12px] font-black tracking-widest transition",
//                         on
//                           ? "border-white/70 bg-[#d9d9d9] text-[#ff5a12] shadow-[0_18px_36px_rgba(255,255,255,0.18)]"
//                           : "border-white/40 bg-white/14 text-white/90 hover:bg-white/22",
//                       ].join(" ")}
//                     >
//                       {t.label}
...
//               <div className="grid grid-cols-12 gap-0">
//                 {filtered.map((r) => (
//                   <Tile key={r.id} className="col-span-12 sm:col-span-6 lg:col-span-4 min-h-[520px]">
//                     <RoleCard role={r} onApply={() => setActiveRole(r)} />
//                   </Tile>
//                 ))}
...
//                     <div className="grid h-full place-items-center p-10 text-center">
//                       <div>
//                         <div className="text-[16px] font-black text-white">No roles found.</div>
//                         <div className="mt-2 text-[13px] text-white/80">Try a different keyword or clear search.</div>
//                       </div>
//                     </div>
//                   </Tile>
//                 )}
...
//                 <div className="flex gap-3">
//                   <button className="rounded-xl bg-[#d9d9d9] px-6 py-3 text-[12px] font-black tracking-widest text-[#ff5a12] shadow-[0_18px_34px_rgba(255,90,18,0.22)] hover:brightness-[1.02] active:translate-y-[1px]">
//                     SEND CV
//                   </button>
//                   <button className="rounded-xl border border-white/55 bg-white/16 px-6 py-3 text-[12px] font-black tracking-widest text-white hover:bg-white/24 active:translate-y-[1px]">
//                     EMAIL US
...
// function RoleCard({ role, onApply }) {
//   return (
//     <article className="cr-card flex h-full flex-col bg-[#d9d9d9]">
//       {/* top */}
//       <div className="border-b border-[#ff5a12]/15 bg-[#d9d9d9] px-5 py-4">
//         <div className="cr-jitter text-[16px] font-black tracking-wide text-[#ff5a12]">{role.title}</div>
//         <div className="mt-1 text-[12px] font-semibold text-[#ff5a12]/75">
//           {role.team.toUpperCase()} • {role.level}
//         </div>
//       </div>
...
//       {/* middle */}
//       <div className="flex-1 p-5">
//         <div className="cr-meta fx-scan rounded-2xl bg-[#d9d9d9] p-4 shadow-[0_18px_40px_rgba(255,90,18,0.20)]">
//           <div className="flex flex-wrap gap-2">
//             <Pill>{role.type}</Pill>
//             <Pill>{role.location}</Pill>
//           </div>

//           <p className="mt-4 text-[13px] leading-relaxed text-[#ff5a12]/85">{role.desc}</p>
...
//       {/* bottom */}
//       <div className="mt-auto flex items-center justify-between border-t border-[#ff5a12]/15 bg-[#d9d9d9] px-5 py-4">
//         <div className="text-[12px] font-black tracking-[0.22em] text-[#ff5a12]/70">APPLY</div>

//         <button
//           onClick={onApply}
//           className="cr-btnWhite rounded-xl bg-[#d9d9d9] px-4 py-2 text-[12px] font-black tracking-widest text-[#ff5a12]
//           shadow-[0_16px_30px_rgba(255,90,18,0.26)] hover:brightness-[1.02] active:translate-y-[1px]"
//         >
//           APPLY NOW
//         </button>
//       </div>
...
//         <div className="flex items-start justify-between border-b border-white/25 bg-white/10 px-6 py-5">
//           <div>
//             <div className="text-[12px] font-black tracking-[0.24em] text-white/90">APPLYING FOR</div>
//             <div className="mt-2 text-[20px] font-black text-white">{role.title}</div>
//             <div className="mt-1 text-[13px] text-white/85">
//               {role.type} • {role.location} • {role.level}
//             </div>
//           </div>
...
//             <button
//               type="submit"
//               className="rounded-xl bg-[#d9d9d9] px-6 py-3 text-[12px] font-black tracking-widest text-[#ff5a12]
//               shadow-[0_18px_34px_rgba(255,90,18,0.22)] hover:brightness-[1.02]"
//             >
//               SUBMIT
//             </button>
//           </div>
...
//   return (
//     <label className="block">
//       <div className="mb-2 text-[12px] font-black tracking-[0.24em] text-white/90">{label}</div>
//       {children}
//     </label>
//   );
// }
