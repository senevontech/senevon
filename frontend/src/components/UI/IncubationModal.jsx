...
//     // optional external handler (API etc.)
//     if (onSubmit) onSubmit(payload);

//     // basic UX: close after submit
//     onClose?.();
//   };
...
//       {/* Panel wrapper (mobile-first, scroll-safe) */}
...
//           className={cn(
//             "relative border border-black/25 bg-[#d9d9d9]",
//             // ✅ scroll safety: panel never exceeds viewport
//             "max-h-[calc(100vh-92px)] overflow-hidden"
//           )}
//         >
...
//           {/* Content: scroll area */}
//           <div className="relative overflow-y-auto max-h-[calc(100vh-180px)]">
...
//                   {/* Footer CTA */}
//                   <div className="mt-1 flex flex-col sm:flex-row gap-3 sm:items-center sm:justify-between border-t border-black/15 pt-4">
...
//                 <div
//                   data-inc-item
//                   className="mt-3 text-[12px] text-black/55"
//                 >
